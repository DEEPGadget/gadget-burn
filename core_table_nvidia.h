...
#define GB_NVIDIA_CORE_ENTRIES                                                  \
    ...
    { "RTX PRO 6000 Blackwell Server Edition", 24064, 376, 752,  256,  256, 128, 0, 512 }, \
    { "RTX PRO 6000 Blackwell Max-Q",          24064, 376, 752,  256,  256, 128, 0, 512 }, \
    { "RTX PRO 6000 Blackwell",                24064, 376, 752,  256,  256, 128, 0, 512 }, \
    /* Blackwell GeForce — GB202 (170 SM), GB203 (84 SM)                       \
       FP64=2/SM (소비자급). HW 강제 반속 → tc_ops_mix = tc_ops/2 = 128        \
       TF32 dense = tc_ops/4 = 64 (이중 페널티) */                            \
    { "GeForce RTX 5090",                      21760, 340, 680,  256,  128,  64, 0, 256 }, \
    { "GeForce RTX 5080",                      10752, 168, 336,  256,  128,  64, 0, 256 }, \
    /* Ada GeForce — AD102 (128 SM), AD103 (76 SM)                             \
       FP64=2/SM (소비자급). HW 강제 반속, TF32 이중 페널티 */                 \
    { "GeForce RTX 4090",                      16384, 256, 512,  256,  128,  64, 0, 256 }, \
    { "GeForce RTX 4080",                       9728, 152, 304,  256,  128,  64, 0, 256 }, \
    /* Ada Professional / Data Center — AD102 full (142 SM)                    \
       whitepaper 명시대로 풀스피드, TF32 = tc_ops/2 = 128 */                  \
    { "RTX 6000 Ada",                          18176, 284, 568,  256,  256, 128, 0, 512 }, \
    { "L40S",                                  18176, 284, 568,  256,  256, 128, 0, 512 }, \
    /* Hopper — GH100 (132 SM for H200 NVL)                                    \
       FP64=64/SM=8448 (전용 코어). FP16 dense = 989 TFLOPS @ 1830 MHz         \
       TF32 dense = 494 TFLOPS = tc_ops/2 = 512 */                            \
    { "H200 NVL",                              16896, 8448, 528, 1024, 1024,  512, 0, 2048 }, \
    { "H200",                                  16896, 8448, 528, 1024, 1024,  512, 0, 2048 }, \
    ...
    { "B200",                                  20480, 10240, 640, 2048, 2048, 1024, 0, 4096 }, \
